...
var  myChart_Line_dataSetElementTemplate={
    label: 'Monthly Report',
    data: [12, 19, 13, 9, 12, 11, 12, 19, 13, 9, 12, 11],
    backgroundColor: [
        //'rgba(11, 81, 183, 0.1)',
         chartjsExtends.colors[4].background
     ],
     borderColor: [
        chartjsExtends.colors[4].border
 ...
 var myChart_Line = new Chart(ctx1, {
     type: 'line',
     data: {
        labels: ['Jan','Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
         datasets: [{
             label: 'Monthly Report',
             data: [12, 100, 13, 9, 12, 11, 12, 19, 13, 9, 12, 11],
             backgroundColor: [
                //'rgba(11, 81, 183, 0.1)',
                chartjsExtends.colors[4].background
             ],
...
//  });
 ...
 var myChart_Doughnut = new Chart(ctx3, {
     type: 'doughnut',
     data: {
        labels: [            
            "水位計",
            ...
            "灌溉量",],
         datasets: [{
             data: [80, 50, 100, 121,100,63.55],
             backgroundColor: [
                chartjsExtends.colors[0].background,
                chartjsExtends.colors[1].background,
                chartjsExtends.colors[2].background,
                chartjsExtends.colors[3].background,
                chartjsExtends.colors[4].background,
                chartjsExtends.colors[5].background,
            ],
            cutout: 100,
            radius: 100,
